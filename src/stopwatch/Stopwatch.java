...
public class Stopwatch extends JFrame {
	...
	public Stopwatch(String title) {
		...
		// Create and set up the content page
		...
		exitButton.setText("Stop ALL Watches");
		...
		// Make the window visible, and set the size to either a fixed size, or have it
		// packed tight
