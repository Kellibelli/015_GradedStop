...
public class StartHere {
	...
	public static void main(String[] args) {
		...
		createOption = JOptionPane.showConfirmDialog(null, "Would you like to create a stopwatch?", "Stopwatch Creation by KelliG", JOptionPane.YES_NO_OPTION);
		...
		do {
			...
			if (createOption == 0) {
				...
				watchName = JOptionPane.showInputDialog(null, "Enter a name for your ADDITIONAL stopwatch");
				Stopwatch watch = new Stopwatch(watchName);
				watch.setLocationByPlatform(true);
				watch.setVisible(true);
			}
